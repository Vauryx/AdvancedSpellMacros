Hooks.once('init', async function () {
    function detectMagicContinous(rollData) {
       ...
       let args = rollData;
        ...
        async function registerDetectMagicHook() {
    ...
    game.AnimFunctions = {};
    game.AnimFunctions.detectMagicContinous = detectMagicContinous;
});
